...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackChanges.json_edited_content'
        db.add_column('assessment_trackchanges', 'json_edited_content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackChanges.json_edited_content'
        db.delete_column('assessment_trackchanges', 'json_edited_content')
    ...
    models = {
        ...
        'assessment.trackchanges': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'json_edited_content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
